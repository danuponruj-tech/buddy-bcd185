    ...
    <>
      ...
      <div className="bg-white border-b border-gray-200 sticky top-16 z-40">
        <div className="max-w-6xl mx-auto flex gap-6 px-4 py-3 overflow-x-auto">
          <button onClick={() => setPage('dashboard')} className={`font-bold text-lg pb-2 whitespace-nowrap ${page === 'dashboard' ? 'text-purple-600 border-b-3 border-purple-600' : 'text-gray-600'}`}>🏠 Dashboard</button>
            ...
            <div className="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-3xl p-6 border-2 border-indigo-300">
              ...
              <div className="bg-white rounded-xl p-4 border-2 border-indigo-200">
                ...
                <div className="flex flex-col gap-2">
                  <input
                    type="datetime-local"
                    value={new Date(boardRevealTime).toISOString().slice(0, 16)}
                    onChange={(e) => {
                      if (e.target.value) {
...
<button type="submit" className="w-full bg-gradient-to-r from-pink-500 to-red-500 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2"><Send size={20} /> Post Request</button>
</form>
);
}
