          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg sticky top-0 z-50">
            <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center gap-2">
              <div className="min-w-0">
                <h1 className="text-lg font-bold whitespace-nowrap">💝 Buddy BCD 185</h1>
                <p className="text-purple-200 text-xs truncate">Welcome, {userProfile.name}!</p>
              </div>
              <div className="flex items-center gap-2 shrink-0">
                <button onClick={() => setPage('notifications')} className="relative p-2 hover:bg-white/20 rounded-lg transition">
                  <Bell size={22} />
                  {unreadCount > 0 && (
                    <span className="absolute top-0 right-0 bg-red-500 text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">{unreadCount}</span>
                  )}
                </button>
                ...
                <button onClick={handleLogout} className="flex items-center gap-1 bg-white/20 hover:bg-white/30 px-3 py-2 rounded-lg transition text-sm font-bold">
