        ...
        <>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg sticky top-0 z-50">
            <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
              <div>
                <h1 className="text-2xl font-bold">💝 Buddy BCD 185</h1>
                <p className="text-purple-200 text-sm">Welcome, {userProfile.name}!</p>
              </div>
              <div className="flex items-center gap-4">
                ...
                <button onClick={openEditProfile} className="hover:opacity-80 transition" title="Edit Profile">
                  {userProfile.avatar ? (
                    <img src={userProfile.avatar} alt="Profile" className="w-10 h-10 rounded-full object-cover border-2 border-white shadow" />
                  ) : (
                    <div className="w-10 h-10 rounded-full bg-white/30 flex items-center justify-center text-lg font-bold text-white border-2 border-white shadow">
            ...
            <div className="max-w-6xl mx-auto p-4 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 border-2 border-gray-200 shadow-lg">
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-4">
                  {users.map(user => (
                    <div key={user.id} className="flex flex-col items-center bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-3 border-2 border-purple-100">
                      {user.avatar ? (
                    ...
                    {Object.keys(buddyAssignments).length > 0 ? (
                      <div className="space-y-3">
                        {Object.entries(buddyAssignments).map(([userId, buddyId]) => {
                          ...
                          return (
                            <div key={userId} className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-4 border-2 border-purple-200">
                              <div className="flex items-center justify-between gap-3">
                                <div className="flex items-center gap-2 flex-1 min-w-0">
                                  {user.avatar ? (
                                    <img src={user.avatar} alt={user.name} className="w-10 h-10 rounded-full object-cover border-2 border-purple-300 shrink-0" />
                                  ) : (
                                  ...
                                  <p className="font-bold text-purple-700 truncate">{user.name}</p>
                                </div>
                                <div className="text-2xl">💝</div>
                                <div className="flex items-center gap-2 flex-1 min-w-0 justify-end">
                                  <p className="font-bold text-pink-700 truncate">{buddyOfUser.name}</p>
                                  {buddyOfUser.avatar ? (
                                    <img src={buddyOfUser.avatar} alt={buddyOfUser.name} className="w-10 h-10 rounded-full object-cover border-2 border-pink-300 shrink-0" />
                                  ) : (
                                    <div className="w-10 h-10 rounded-full bg-pink-200 flex items-center justify-center text-lg font-bold text-pink-700 shrink-0">
